...
- [ ] Describe a Resource?
      ----- The things our application cares about. The things we want to manage.The nouns in the Application domain.

- [ ] What can the API return to help clients know if a request was successful?
      ------ response with status code and json or send message

- [ ] How can we partition our application into sub-applications?
      ------ By making separation of concerns
